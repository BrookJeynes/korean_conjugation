...
export class Conjugation {
    ...
    constructor() {
        this.tense_rules = [
            ...
            { name: "declarative future informalLow", rule: (infinitive, regular) => this.declarativeFutureInformalLow(infinitive, regular) },
            { name: "declarative future informalHigh", rule: (infinitive, regular) => this.declarativeFutureInformalHigh(infinitive, regular) },
            { name: "declarative future formalLow", rule: (infinitive, regular) => this.declarativeFutureFormalLow(infinitive, regular) },
            { name: "declarative future formalHigh", rule: (infinitive, regular) => this.declarativeFutureFormalHigh(infinitive, regular) },
