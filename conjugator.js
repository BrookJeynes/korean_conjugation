...
export class Conjugation {
    ...
    constructor() {
        this.tense_rules = [
            ...
            { name: "declarativePastInformalLow", rule: (infinitive, regular) => this.declarativePastInformalLow(infinitive, regular) },
            { name: "declarativePastInformalHigh", rule: (infinitive, regular) => this.declarativePastInformalHigh(infinitive, regular) },
            { name: "declarativePastFormalLow", rule: (infinitive, regular) => this.declarativePastFormalLow(infinitive, regular) },
            { name: "declarativePastFormalHigh", rule: (infinitive, regular) => this.declarativePastFormalHigh(infinitive, regular) },
            { name: "futureBase", rule: (infinitive, regular) => this.futureBase(infinitive, regular) },
            { name: "declarativeFutureInformalLow", rule: (infinitive, regular) => this.declarativeFutureInformalLow(infinitive, regular) },
            { name: "declarativeFutureInformalHigh", rule: (infinitive, regular) => this.declarativeFutureInformalHigh(infinitive, regular) },
            { name: "declarativeFutureFormalLow", rule: (infinitive, regular) => this.declarativeFutureFormalLow(infinitive, regular) },
            { name: "declarativeFutureFormalHigh", rule: (infinitive, regular) => this.declarativeFutureFormalHigh(infinitive, regular) },
            { name: "declarativeFutureConditionalInformalLow", rule: (infinitive, regular) => this.declarativeFutureConditionalInformalLow(infinitive, regular) },
            { name: "declarativeFutureConditionalInformalHigh", rule: (infinitive, regular) => this.declarativeFutureConditionalInformalHigh(infinitive, regular) },
            { name: "declarativeFutureConditionalFormalLow", rule: (infinitive, regular) => this.declarativeFutureConditionalFormalLow(infinitive, regular) },
            { name: "declarativeFutureConditionalFormalHigh", rule: (infinitive, regular) => this.declarativeFutureConditionalFormalHigh(infinitive, regular) },
            { name: "inquisitivePresentInformalLow", rule: (infinitive, regular) => this.inquisitivePresentInformalLow(infinitive, regular) },
            { name: "inquisitivePresentInformalHigh", rule: (infinitive, regular) => this.inquisitivePresentInformalHigh(infinitive, regular) },
            { name: "inquisitivePresentFormalLow", rule: (infinitive, regular) => this.inquisitivePresentFormalLow(infinitive, regular) },
            { name: "inquisitivePresentFormalHigh", rule: (infinitive, regular) => this.inquisitivePresentFormalHigh(infinitive, regular) },
            { name: "inquisitivePastInformalLow", rule: (infinitive, regular) => this.inquisitivePastInformalLow(infinitive, regular) },
            { name: "inquisitivePastInformalHigh", rule: (infinitive, regular) => this.inquisitivePastInformalHigh(infinitive, regular) },
            { name: "inquisitivePastFormalLow", rule: (infinitive, regular) => this.inquisitivePastFormalLow(infinitive, regular) },
            { name: "inquisitivePastFormalHigh", rule: (infinitive, regular) => this.inquisitivePastFormalHigh(infinitive, regular) },
            { name: "imperativePresentInformalLow", rule: (infinitive, regular) => this.imperativePresentInformalLow(infinitive, regular) },
            { name: "imperativePresentInformalHigh", rule: (infinitive, regular) => this.imperativePresentInformalHigh(infinitive, regular) },
            { name: "imperativePresentFormalLow", rule: (infinitive, regular) => this.imperativePresentFormalLow(infinitive, regular) },
            { name: "imperativePresentFormalHigh", rule: (infinitive, regular) => this.imperativePresentFormalHigh(infinitive, regular) },
            { name: "propositivePresentInformalLow", rule: (infinitive, regular) => this.propositivePresentInformalLow(infinitive, regular) },
            { name: "propositivePresentInformalHigh", rule: (infinitive, regular) => this.propositivePresentInformalHigh(infinitive, regular) },
            { name: "propositivePresentFormalLow", rule: (infinitive, regular) => this.propositivePresentFormalLow(infinitive, regular) },
            { name: "propositivePresentFormalHigh", rule: (infinitive, regular) => this.propositivePresentFormalHigh(infinitive, regular) },
            { name: "connectiveIf", rule: (infinitive, regular) => this.connectiveIf(infinitive, regular) },
            { name: "connectiveAnd", rule: (infinitive, regular) => this.connectiveAnd(infinitive, regular) },
            { name: "nominalIng", rule: (infinitive, regular) => this.nominalIng(infinitive, regular) },
